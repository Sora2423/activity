    ...
    import Greendots from '../assets/img/illustrations/Green_dots.svg'
    ...
    const Contact = () => {
        return (
            ...
            <div class="position-absolute bottom-0 end-0 z-n1 d-none d-lg-block"><img src={Greendots} alt="" /></div>
            <div class="position-relative bottom-0 start-0 z-1"><img class="img-fluid w-100" src={Wave3} /></div>
        </section>
        )
    }
